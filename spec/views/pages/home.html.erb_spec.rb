...
RSpec.describe 'pages/home.html.erb', type: :view do
  it 'displays titles' do
    ...
    expect(rendered).to include('© Copyright 2021 Ryder, All rights reserved.', 'Bicycles', 'Electric Scooter', 'Summer Equipment', 'Winter Equipment', 'Get Started', 'Rentals', 'Welcome',
