...
ActiveRecord::Schema.define(version: 2021_12_09_165546) do
  ...
  create_table "image_elements", force: :cascade do |t|
    t.bigint "rent_item_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["rent_item_id"], name: "index_image_elements_on_rent_item_id"
  end
  ...
  add_foreign_key "image_elements", "rent_items"
